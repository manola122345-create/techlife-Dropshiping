...
const TRUST = [
  { icon: Truck, title:"Livraison rapide", desc:"2 à 7 jours ouvrés" },
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="relative overflow-hidden bg-gray-900 rounded-3xl px-8 py-14 text-center">
          ...
          <div className="relative">
            ...
            <h2 className="text-4xl font-black text-white mb-3">Livraison gratuite</h2>
            <p className="text-gray-300 text-lg mb-8">Sur toutes les commandes dès <span className="font-black text-white">50€</span></p>
